...
def count_parameters(model):
    ...
    print("model parameter number : {}".format(num_para))
...
class MemTracker(object):
    ...
    """
    def __init__(self, frame, detail=False, path='', verbose=False, device=0):
        self.frame = frame
        ...
        with open(self.gpu_profile_fn, 'a+') as f:
            ...
            if self.print_detail is True:
                ...
                for t, s, n, m in new_tensor_sizes - self.last_tensor_sizes:
                    ...
                    print(f'+ | {str(n)} * Size:{str(s):<20} | Memory: {str(m * n)[:6]} M | {str(t):<20}\n')
